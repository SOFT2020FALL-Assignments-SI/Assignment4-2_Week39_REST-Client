...
public class DemoOps
{
    ...
    static final String endPointGetAll = "http://localhost:8080/students/all";
    static final String endPointGetOne = "http://localhost:8080/students/getByName/{id}}";
    static final String endPointSave = "http://localhost:8080/students/save";
    static final String endPointUpdateId = "http://localhost:8080/students/update/{id}";
    static final String endPointDelete = "http://localhost:8080/students/del(id}";
    ...
    public static void main(String[] args)
    {
        ...
        // Put
        params.put("id", "1002");
        Student updatedStudents = new Student(1002, "Dolly", "test@email.com");
